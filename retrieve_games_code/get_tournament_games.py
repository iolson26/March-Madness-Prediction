...
def get_games(begin_date,end_date):
    ...
    df = pd.DataFrame(columns=["GameID", "Date", "Year", "Home_team", "Away_Team", "Home_winner?","Away_Winner?", "Home_Seed", "Away_Seed"])
    ...
    while current_date <= end_date:
        ...
        for g in games:
            ...
            away_seed = g['game']['away'].get('seed')
