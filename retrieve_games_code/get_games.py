            ...
            if len(games) >= 500:
                ...
                for g in games:
                   #In this section get all of the data about the game
                    ...
                    elif not away_conference or not home_conference:
                        print("SKIPPING GAME: missing conference data")
                    elif away_conference != 'd1' or home_conference != 'd1':
                        print("SKIP BC TEAM IS NOT D1")
                    else:
